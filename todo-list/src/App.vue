  ...
  <div id="app">
    <div class="ui inverted vertical masthead center aligned segment">
      <div class="ui text container">
        ...
        <h2 class="ui inverted header">Marlon Douglas Krauswzcki
          <div class="sub header">Analista de Sistemas</div>
        </h2>
        <h3 class="ui inverted header">Curitiba, Brasil - 2020</h3>
        <a class="tiny ui linkedin button" type="button" href="https://www.linkedin.com/in/marlon-douglas-krauswzcki-477a1441/">
